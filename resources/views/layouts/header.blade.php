...
<body>
  ...
  width: 100px;" alt="Brand Logo" class="img-fluid">
            ...
            <div class="layout-container">
                ...
                <nav style="position:fixed; width:100%" class="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-dark container-p-x" id="layout-navbar">
                    <!-- Brand demo (see assets/css/demo/demo.css) -->
                    ...
                    <div class="navbar-collapse collapse" id="layout-navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-lg-center ml-auto" style="margin-right:230px">
