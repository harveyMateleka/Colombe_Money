                            ...
                            <form action="#" method="POST" id="form_agence">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" data-validation="required" name="Montcdf" placeholder="ENTREE MONTANT CDF" id="Montcdf">
                                        <div class="clearfix"></div>
                                    </div>

                                    <div class="form-group col-md-4">
                                        <label class="form-label">Montant USD</label>
                                        <input type="text" class="form-control" data-validation="required" name="Montusd" placeholder="ENTREE MONTANT USD" id="Montusd">
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                <div class="form-row">
